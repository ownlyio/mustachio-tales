            ...
            >
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-start pt-4" style={{position: "relative"}}>
                        ...
                        {filterChapters(ChapterPages, 61, 90).map((x, k) => (
                            !x.subpage ? (
                                <div className="row tc-link" onClick={() => flipPage.gotoPage(x.pageIndexTab)} key={x.id}>
                                    <div className="col-7">
                                        <p className="font-w-hermann text-lg w-hermann-semibold mb-0">{x.title}</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-start pt-4" style={{position: "relative"}}>
                        ...
                        {filterChapters(ChapterPages, 91).map((x, k) => (
                            !x.subpage ? (
                                <div className="row tc-link" onClick={() => flipPage.gotoPage(x.pageIndexTab)} key={x.id}>
                                    <div className="col-7">
                                        <p className="font-w-hermann text-lg w-hermann-semibold mb-0">{x.title}</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Ninja</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-start" style={{position: "relative"}}>
                        ...
                        <p className="text-center font-w-hermann w-hermann-semibold-italic page-num">108</p>
                    </div>
                </article>
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-start" style={{position: "relative"}}>
                        ...
                        <p className="text-center font-w-hermann w-hermann-semibold-italic page-num">109</p>
                    </div>
                </article>
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-start" style={{position: "relative"}}>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">BubbleGum</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Loonywise</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Paddle</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">PanCake Prince</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Paratrooper</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Peco Rider</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Penny</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">PepperMint Butler</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Pilot</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Pumpkin Man</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Dako</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Laya</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Raggedy Prince</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Scare Crow</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Shoko</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Sign Maker</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">SkateZone</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-center" style={{position: "relative"}}>
                        ...
                        <p className="text-center text-lg font-w-hermann w-hermann-reg mb-0">The Tale of</p>
                        <p className="text-center text-3xl font-w-hermann w-hermann-ultrabold mb-4">Slendie</p>
                ...
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-start" style={{position: "relative"}}>
                        ...
                        <p className="text-center font-w-hermann w-hermann-semibold-italic page-num">150</p>
                    </div>
                </article>
                <article className="page h-90vh">
                    <div className="h-90vh d-flex flex-column justify-content-start" style={{position: "relative"}}>
