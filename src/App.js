...
import lizzardprince from './images/ch_6/characters/lizzardprince.png'
                    ...
                    >
                        ...
                        <article className="page">
                            <div className="d-flex justify-content-around h-full">
                                <div className="w-2/4 bg-white">
                                    <div className="h-full d-flex flex-column justify-content-start" style={{position: "relative"}}>
                                        <p className="text-center font-w-hermann w-hermann-italic mt-3">Chapter 5: Mysr of the Ancient Cellar</p>
